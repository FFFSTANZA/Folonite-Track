      ...
      <aside className="relative hidden w-full flex-1 overflow-hidden md:block">
        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-10">
          <div className="max-w-[200px]">
            <span className="text-2xl font-semibold tracking-tight text-foreground">Folonite</span>
          </div>
          ...
          <Card className="rounded-2xl border border-border/60 bg-card/95 shadow-soft">
            ...
            <CardContent>
              ...
              >
                ...
                <Button type="submit" className="h-11 w-full rounded-full bg-primary text-sm font-medium text-primary-foreground shadow-soft transition-opacity hover:opacity-90">Sign in to Demo</Button>
              </form>
            </CardContent>
          </Card>
        </div>
