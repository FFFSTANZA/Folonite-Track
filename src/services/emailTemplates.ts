    ...
    <div class="email-container">
      ...
      <div class="email-footer">
        <div class="footer-links">
          <p>
            <a href="https://folonite.in">Visit Website</a> • 
            <a href="mailto:support@folonite.in">Contact Support</a>
          </p>
...
export function approvalSubmittedTemplate(data: {
  ...
  const html = wrapTemplate(`
    <div class="email-body">
      ...
      <a href="${data.dashboardUrl || 'https://folonite.in'}/approvals" class="button">Review Request</a>
    </div>
...
Review: ${data.dashboardUrl || 'https://folonite.in'}/approvals
  `.trim();
...
export function approvalForwardedTemplate(data: {
  ...
  const html = wrapTemplate(`
    <div class="email-body">
      ...
      <a href="${data.dashboardUrl || 'https://folonite.in'}/approvals" class="button">Review & Decide</a>
    </div>
...
export function approvalApprovedTemplate(data: {
  ...
  const html = wrapTemplate(`
    <div class="email-body">
      ...
      <a href="${data.dashboardUrl || 'https://folonite.in'}/assets" class="button">View Asset</a>
    </div>
...
View Asset: ${data.dashboardUrl || 'https://folonite.in'}/assets
  `.trim();
...
export function approvalRejectedTemplate(data: {
  ...
  const html = wrapTemplate(`
    <div class="email-body">
      ...
      <a href="${data.dashboardUrl || 'https://folonite.in'}/approvals" class="button">View Details</a>
    </div>
...
View Details: ${data.dashboardUrl || 'https://folonite.in'}/approvals
  `.trim();
...
export function newsletterPublishedTemplate(data: {
  ...
  const html = wrapTemplate(`
    <div class="email-body">
      ...
      <a href="${data.dashboardUrl || 'https://folonite.in'}/newsletter" class="button">Read Full Update</a>
...
Read more: ${data.dashboardUrl || 'https://folonite.in'}/newsletter
  `.trim();
...
export function ticketAssignedTemplate(data: {
  ...
  const html = wrapTemplate(`
    <div class="email-body">
      ...
      <a href="${data.dashboardUrl || 'https://folonite.in'}/tickets" class="button">View Ticket</a>
    </div>
...
View: ${data.dashboardUrl || 'https://folonite.in'}/tickets
  `.trim();
...
export function auditStartedTemplate(data: {
  ...
  const html = wrapTemplate(`
    <div class="email-body">
      ...
      <a href="${data.dashboardUrl || 'https://folonite.in'}/audit" class="button">Go to Audit</a>
    </div>
...
Go to Audit: ${data.dashboardUrl || 'https://folonite.in'}/audit
  `.trim();
...
export function auditSubmittedTemplate(data: {
  ...
  const html = wrapTemplate(`
    <div class="email-body">
      ...
      <a href="${data.dashboardUrl || 'https://folonite.in'}/audit" class="button">View Audit Report</a>
    </div>
...
View Report: ${data.dashboardUrl || 'https://folonite.in'}/audit
  `.trim();
...
export function welcomeEmailTemplate(data: {
  ...
  const html = wrapTemplate(`
    <div class="email-body">
      ...
      <a href="${data.dashboardUrl || 'https://folonite.in'}/login" class="button">Login to Dashboard</a>
...
Login: ${data.dashboardUrl || 'https://folonite.in'}/login
  `.trim();
...
Log in at: ${data.dashboardUrl || "https://folonite.in/login"}
  `.trim();
